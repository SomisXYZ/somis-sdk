...
var SuiNftService = class {
  constructor(provider) {
    ...
    this.nftClient = new import_js_sdk.NftClient(provider);
    this.collectionDataLoader = new import_dataloader.default(async (collectionIds) => {
    ...
    this.nftDataLoader = new import_dataloader.default(async (nftIds) => {
